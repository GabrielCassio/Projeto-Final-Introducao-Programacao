...
def tela_inicial(tela, LARGURA, ALTURA):
    ...
    # =========================
    # CAVEIRA ANIMADA (fixa distância)
    # =========================
    caveira_x = 0.0
    caveira_y = 0.0
    caveira_init = False
    ...
    while True:
        ...
        # =========================
        # DESENHO: FUNDO (sem overlay extra)
        # =========================
        ...
        # =========================
        # TÍTULO + SUBTÍTULO (igual estilo original)
        # =========================
        ...
        # Render opções e guarda posição do texto selecionado
        x_sel = 0
        y_sel = 0
        w_sel = 0
        ...
        # =========================
        # CAVEIRA: distância igual em todos os itens
        # =========================
        padding = 14  # distância fixa até o começo do texto
        ...
        # suaviza X/Y (mais “premium” sem inventar UI nova)
